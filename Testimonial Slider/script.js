...
image.setAttribute("src", `${testimonials[currentTestimonial].photoUrl}`);
userComment.textContent = `${testimonials[currentTestimonial].text}`;
userName.textContent = `${testimonials[currentTestimonial].name}`;
testimonialSlider();
